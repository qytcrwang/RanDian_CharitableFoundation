...
public class WxPayTrade {
    ...
    public void setStSign(String stSign) {
        this.stSign = stSign == null ? null : stSign.trim();
    }

    public String getNdSign() {
        return ndSign;
    }

    public void setNdSign(String ndSign) {
        this.ndSign = ndSign == null ? null : ndSign.trim();
    }
