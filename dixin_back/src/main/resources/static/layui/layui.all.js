...
!function (e, t) {
  ...
  var Ye = /^(?:input|select|textarea)$/i, Je = /^key/,
      Ge = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Ke = /^(?:focusinfocus|focusoutblur)$/,
      Qe = /^([^.]*)(?:\.(.+)|)/;
  pe.event = {
    global: {},
    ...
    dispatch: function (e) {
      ...
      var t, n, r, i, o, a = [], s = ie.call(arguments),
          u = (pe._data(this, "events") || {})[e.type] || [], l = pe.event.special[e.type] || {};
...
layui.define("layer", function (e) {
  ...
  var t = layui.$, i = layui.layer, a = layui.hint(), n = layui.device(), l = "form",
      r = ".layui-form", s = "layui-this", o = "layui-hide", c = "layui-disabled", u = function () {
        this.config = {
          verify: {
            required: [/[\S]+/, "必填项不能为空"],
  ...
  var d = function () {
    var e = null, a = f.config.verify, s = "layui-form-danger", o = {}, c = t(this),
        u = c.parents(r), d = u.find("*[lay-verify]"), v = c.parents("form")[0],
        h = c.attr("lay-filter");
      ...
      if (o.removeClass(s), layui.each(c, function (t, l) {
        ...
        if (a[l]) {
          ...
          if (f = f || a[l][1], "required" === l && (f = o.attr("lay-reqText") || f), c) return "tips" === u ? i.tips(f, function () {
            ...
            title: "提示",
            shadeClose: !0
          }) : i.msg(f, {icon: 5, shift: 6}), n.android || n.ios || setTimeout(function () {
            r.focus()
          }, 7), o.addClass(s), e = !0
        }
      }), e) return e
...
layui.define("form", function (e) {
  ...
  var i = layui.$, a = layui.form, n = layui.layer, t = "tree", r = {
      ...
      h = "layui-icon-addition", u = "layui-icon-subtraction", p = "layui-tree-entry",
      f = "layui-tree-main", y = "layui-tree-txt", v = "layui-tree-pack", C = "layui-tree-spread",
      k = "layui-tree-setLineShort", m = "layui-tree-showLine", x = "layui-tree-lineExtend",
      b = function (e) {
        var a = this;
  ...
  b.prototype.config = {
    ...
    var n = this, t = n.config, r = e.children("." + p), l = r.children("." + f),
        c = r.find("." + o), k = r.find("." + y), m = t.onlyIconControl ? c : l, x = "";
    ...
    a.elem.find("." + s).each(function (a, n) {
      var t = i(this).data("id"), r = i(n).children("." + p).find('input[same="layuiTreeCheck"]'),
          l = r.next();
      if ("number" == typeof e) {
...
layui.define(["laytpl", "form"], function (e) {
  ...
  x.prototype.config = {
    ...
    var e = this, n = e.config, i = e.elem = a(t(v).render({data: n, index: e.index})),
        l = n.elem = a(n.elem);
    ...
    e.elem.on("click", 'input[lay-filter="layTransferCheckbox"]+', function () {
      ...
      var n = this.value, i = a(this).parents("." + h).eq(0).siblings("." + y),
          l = i.children("li");
      l.each(function () {
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
  ...
  F.prototype.config = {
    ...
    var l = a.elem, n = l.next("." + v),
        o = e.elem = t(i(z).render({VIEW_CLASS: v, data: a, index: e.index}));
    ...
    var c = this, s = c.config, y = e[s.response.dataName] || [], h = e[s.response.totalRowName],
        v = [], m = [], g = [], b = function () {
          var e;
